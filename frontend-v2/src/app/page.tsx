...
const StudyMode = dynamic(() => import("@/components/StudyMode"), {
  ssr: false,
});
...
// Pages
const ProgressPage = dynamic(() => import("@/components/pages/ProgressPage"), {
  ssr: false,
});
            ...
            >
              ...
              {(activeTool === "exegesis" || activeTool === "study_mode") && (
                <Workspace
                  ...
                  middleTitle={
                    activeTool === "exegesis"
                      ? "Análise Crítica & Interlinear"
                      : "Guia de Passagem & Comentários"
                  }
                  ...
                  leftPane={
                    <BibleReader
                      hideHeader
                      onClose={() => {}}
                      onOpenWordStudy={openWordStudyWithStrong}
                    />
                  }
                  rightPane={
                    activeTool === "exegesis" ? (
              ...
              {activeTool === "encyclopedia" && (
                <Encyclopedia onClose={closeTool} />
              )}
