...
export const BIBLICAL_PEOPLE: BiblicalPerson[] = [
  {
    ...
    covenant: "Adâmica",
    theologicalFunction:
      "Cabeça federal da humanidade; tipo de Cristo (o 'Último Adão').",
    genealogy: "Criado diretamente por Deus; pai de Sete, Caim e Abel.",
    description:
      "O primeiro homem, representante de toda a raça humana no pacto das obras.",
  ...
  },
  {
    ...
    covenant: "Adâmica",
    theologicalFunction:
      "Criador, Sustentador, Legislador e Redentor. O motor primário de toda a história bíblica.",
    genealogy: "Autoexistente (Sem princípio nem fim).",
    description:
      "O Deus Triúno que traz todas as coisas à existência e governa com soberania absoluta.",
  ...
  },
  {
    ...
    covenant: "Noética",
    theologicalFunction:
      "Preservador da vida pós-julgamento; receptor da aliança da graça comum.",
    genealogy: "Filho de Lameque; pai de Sem, Cam e Jafé.",
    description:
      "Patriarca que sobreviveu ao Dilúvio, através de quem Deus renovou a vida na terra.",
  ...
  },
  {
    ...
    covenant: "Abraâmica",
    theologicalFunction:
      "Pai de todos os que creem; recebedor da promessa da semente e da terra.",
    genealogy: "Filho de Terá; pai de Isaque e Ismael.",
    description:
      "Chamado de Ur para fundar a nação de Israel, através de quem todas as famílias da terra seriam abençoadas.",
  ...
  },
  {
    ...
    covenant: "Mosaica",
    theologicalFunction:
      "Mediador da Antiga Aliança; legislador e tipo do grande Profeta vindouro.",
  ...
  },
  {
    ...
    covenant: "Davídica",
    theologicalFunction:
      "Rei teocrático ideal; protótipo do Messias (o 'Filho de Davi').",
    genealogy: "Filho de Jessé; da tribo de Judá; ancestral de Jesus.",
    description:
      "Segundo rei de Israel, estabeleceu o trono eterno através da promessa messiânica.",
  ...
  },
  {
    ...
    theologicalFunction:
      "Mediador da Nova Aliança; o Messias, Deus encarnado, Salvador e Sumo Sacerdote.",
    genealogy: "Linhagem de Davi; Filho de Deus e Filho do Homem.",
    description:
      "O cumprimento de todas as alianças anteriores e o Redentor do mundo.",
  ...
  },
  {
    ...
    covenant: "Nova Aliança",
    theologicalFunction:
      "Apóstolo dos gentios; principal sistematizador da teologia da Nova Aliança.",
    genealogy: "Tribo de Benjamim; cidadão romano.",
    description:
      "Missionário e autor de grande parte do Novo Testamento, expandiu a fé para o mundo greco-romano.",
