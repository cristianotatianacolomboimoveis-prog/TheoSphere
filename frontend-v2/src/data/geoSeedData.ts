...
export const SEED_LOCATIONS: GeoLocation3D[] = [
  {
    ...
    theologicalSignificance:
      "O Centro do Mundo Teológico; local da morada de Deus (Templo) e da Redenção (Cruz). Antítese da Babilônia.",
    archaeologicalNotes:
      "Escavações na Cidade de Davi e no Túnel de Ezequias confirmam a ocupação contínua desde o Bronze Médio.",
  ...
  },
  {
    id: "babilonia",
    type: "city",
    coordinates: [44.4208, 32.543],
    names: { canonical: "Babylon", pt: "Babilônia" },
    theologicalSignificance:
      "Símbolo da confusão, do orgulho humano contra Deus e do exílio. Representa o sistema mundial oposto a Sião.",
    archaeologicalNotes:
      "Ruínas do Etemenanki (Zigurante) e o Portão de Ishtar (atualmente no Museu de Pérgamo).",
  ...
  },
  {
    ...
    theologicalSignificance:
      "Local da Teofania e da Aliança Mosaica. Onde a santidade de Deus foi revelada através da Lei.",
    archaeologicalNotes:
      "Identificação tradicional em Jebel Musa, embora existam teorias alternativas (ex: na Arábia Saudita).",
    era: "Bronze Tardio",
  ...
  },
  {
    ...
    theologicalSignificance:
      "Cidade Messiânica; o 'Pão da Vida' nasceu na 'Casa do Pão'. Cumprimento da linhagem Davídica.",
    archaeologicalNotes:
      "Igreja da Natividade construída sobre uma gruta venerada desde o século II.",
  ...
  },
  {
    ...
    theologicalSignificance:
      "Fronteira da Promessa; símbolo de transição, batismo e novo começo teológico.",
    archaeologicalNotes:
      "Locais de batismo identificados em Al-Maghtas e Qasr al-Yahud.",
    era: "Geológica",
  ...
  },
  {
    ...
    theologicalSignificance:
      "O Palco do Império; local onde o Reino de Deus confrontou o poder humano. Destino final da missão paulina.",
    archaeologicalNotes:
      "Catacumbas e o Fórum Romano testemunham a perseguição e posterior triunfo do cristianismo.",
  ...
  },
  {
    ...
    theologicalSignificance:
      "O palco da história humana e da revelação divina. Criada boa, corrompida pela Queda e destinada à renovação em Cristo.",
  ...
  },
  {
    ...
    theologicalSignificance:
      "O domínio da morada de Deus e das hostes celestiais. Criado simultaneamente com a terra como a esfera espiritual da realidade.",
    archaeologicalNotes:
      "Designa tanto a expansão física quanto a dimensão espiritual.",
    era: "Criação - Presente",
  ...
  },
  {
    ...
    theologicalSignificance:
      "O protótipo do Templo; lugar de comunhão perfeita entre Deus e o homem. O paraíso perdido que será restaurado.",
    archaeologicalNotes:
      "Muitos sugerem a localização próxima aos rios Tigre e Eufrates.",
    era: "Era Primitiva",
