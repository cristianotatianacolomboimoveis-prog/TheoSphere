...
export const STRONGS_HEBREW: Record<string, StrongsEntry> = {
  H430: {
    ...
    definition: "God, gods, judges; the supreme God",
    definitionPt: "Deus, deuses, juízes; o Deus supremo (plural majestático)",
  ...
  H3068: {
    ...
    definition: "The LORD, Jehovah; the proper name of the God of Israel",
    definitionPt:
      "O SENHOR, Jeová; o nome próprio do Deus de Israel (tetragrama)",
    partOfSpeech: "Noun, Proper",
    occurrences: 6519,
    kjvTranslations: [
      { word: "LORD", count: 6510 },
      { word: "GOD", count: 4 },
      { word: "Jehovah", count: 4 },
    ],
  ...
  H2617: {
    ...
    definition: "Lovingkindness, mercy, faithfulness, steadfast love",
    definitionPt: "Amor leal, misericórdia, fidelidade, bondade inabalável",
    partOfSpeech: "Noun, Masculine",
    occurrences: 249,
    kjvTranslations: [
      { word: "mercy", count: 149 },
      { word: "kindness", count: 40 },
      { word: "lovingkindness", count: 30 },
      { word: "goodness", count: 12 },
    ],
  ...
  H7965: {
    ...
    definition: "Peace, completeness, welfare, wholeness",
    definitionPt: "Paz, completude, bem-estar, integridade, prosperidade",
    partOfSpeech: "Noun, Masculine",
    occurrences: 237,
    kjvTranslations: [
      { word: "peace", count: 175 },
      { word: "well", count: 14 },
      { word: "peaceably", count: 9 },
      { word: "welfare", count: 5 },
    ],
  ...
  H8451: {
    ...
    definition: "Law, instruction, teaching, direction",
    definitionPt: "Lei, instrução, ensino, direção; a Lei de Moisés",
  ...
  H6666: {
    ...
    definitionPt: "Justiça, retidão, equidade divina",
    partOfSpeech: "Noun, Feminine",
    occurrences: 159,
    kjvTranslations: [
      { word: "righteousness", count: 128 },
      { word: "justice", count: 15 },
      { word: "right", count: 9 },
    ],
  ...
  H1285: {
    ...
    definition: "Covenant, alliance, treaty, agreement",
    definitionPt: "Aliança, pacto, tratado, acordo solene com Deus",
    partOfSpeech: "Noun, Feminine",
    occurrences: 284,
    kjvTranslations: [
      { word: "covenant", count: 264 },
      { word: "league", count: 17 },
      { word: "confederacy", count: 1 },
    ],
  ...
  H3444: {
    ...
    definitionPt: "Salvação, libertação, vitória; raiz do nome Jesus",
    partOfSpeech: "Noun, Feminine",
    occurrences: 78,
    kjvTranslations: [
      { word: "salvation", count: 65 },
  ...
  H6944: {
    ...
    definition: "Holiness, sacredness, holy thing, sanctuary",
    definitionPt: "Santidade, sacralidade, coisa sagrada, santuário",
    partOfSpeech: "Noun, Masculine",
    occurrences: 470,
    kjvTranslations: [
      { word: "holy", count: 262 },
      { word: "sanctuary", count: 68 },
      { word: "hallowed", count: 25 },
      { word: "holiness", count: 16 },
    ],
  ...
  H1: {
    ...
    transliteration: "ab",
    pronunciation: "ahv",
    definition: "Father, ancestor, originator",
    definitionPt: "Pai, ancestral, originador; título de Deus como Pai",
    partOfSpeech: "Noun, Masculine",
    occurrences: 1211,
    kjvTranslations: [
      { word: "father", count: 1070 },
      { word: "chief", count: 2 },
  ...
  H4899: {
    ...
    definition: "Anointed one, Messiah",
    definitionPt: "Ungido, Messias; o prometido libertador de Israel",
    partOfSpeech: "Adjective/Noun",
    occurrences: 39,
    kjvTranslations: [
      { word: "anointed", count: 37 },
  ...
  H7307: {
    ...
    definition: "Spirit, wind, breath; the Spirit of God",
    definitionPt: "Espírito, vento, sopro; o Espírito de Deus",
    partOfSpeech: "Noun, Feminine",
    occurrences: 378,
    kjvTranslations: [
      { word: "spirit", count: 232 },
      { word: "wind", count: 92 },
      { word: "breath", count: 28 },
      { word: "mind", count: 6 },
    ],
  ...
  H3045: {
    ...
    definition: "To know, perceive, discern, experience",
    definitionPt:
    ...
    kjvTranslations: [
      { word: "know", count: 645 },
      { word: "known", count: 105 },
      { word: "knowledge", count: 19 },
      { word: "perceive", count: 18 },
    ],
  ...
  H539: {
    ...
    definition: "To believe, be faithful, trust; Amen",
    definitionPt: "Crer, ser fiel, confiar; raiz da palavra Amém",
    partOfSpeech: "Verb",
    occurrences: 108,
    kjvTranslations: [
      { word: "believe", count: 44 },
      { word: "faithful", count: 20 },
      { word: "sure", count: 11 },
      { word: "established", count: 7 },
    ],
  ...
  H3474: {
    ...
    definitionPt: "Glória, honra, esplendor, peso; a glória manifesta de Deus",
    partOfSpeech: "Noun, Masculine",
    occurrences: 200,
    kjvTranslations: [
      { word: "glory", count: 156 },
      { word: "honour", count: 32 },
      { word: "glorious", count: 10 },
    ],
...
export function searchStrongsHebrew(query: string): StrongsEntry[] {
  ...
  return Object.values(STRONGS_HEBREW).filter(
    (entry) =>
