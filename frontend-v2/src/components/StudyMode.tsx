      ...
      <header className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-[#0F172A]/80 backdrop-blur-xl">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-black text-sm uppercase tracking-[0.2em] italic">
              TheoSphere <span className="text-[#D4AF37]">Scholar</span>
            </h2>
          </div>
        ...
        <div className="flex items-center gap-4">
          <form onSubmit={handleSearch} className="relative group">
            ...
            />
            {searching && (
              <div className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 border-2 border-[#D4AF37] border-t-transparent rounded-full animate-spin" />
            )}
          </form>
          <button
            ...
            <AnimatePresence mode="wait">
              ...
              {rightPanel === "3d" && (
                <div className="w-full h-full flex flex-col items-center justify-center bg-slate-950">
                  <div className="text-[#D4AF37] animate-pulse font-black uppercase tracking-widest text-xs">
                    Aguardando Seleção de Artefato...
                  </div>
                  <p className="text-slate-500 text-[10px] mt-2 uppercase tracking-widest">
                    Navegue no Atlas para carregar modelos 3D
                  </p>
                </div>
              )}
            </AnimatePresence>
          ...
          <div className="absolute bottom-6 left-6 right-6 z-[1001] pointer-events-none">
            <div className="bg-[#0F172A]/90 backdrop-blur-2xl p-4 rounded-[24px] border border-white/10 shadow-2xl pointer-events-auto flex items-center justify-between max-w-2xl mx-auto">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] text-blue-400 font-bold uppercase tracking-widest">
                    Insight da IA Teológica
                  </p>
                  <p className="text-xs text-slate-300 line-clamp-1">
                    Esta localização é estratégica para o entendimento do pacto
                    mosaico...
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <button className="px-4 py-2 bg-blue-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-500 transition-all">
                  Ver Detalhes
                </button>
              </div>
            </div>
