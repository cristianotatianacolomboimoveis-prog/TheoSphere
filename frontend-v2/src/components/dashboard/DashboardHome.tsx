        ...
        <div className="mb-10 flex items-end justify-between border-b border-gray-300 dark:border-white/10 pb-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-white/40 text-sm mt-1">
              Sua jornada teológica continua hoje em{" "}
              <span className="text-blue-600 font-bold italic">Gênesis 32</span>
              .
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <DashboardCard
              ...
              subtitle="15 de Ago, 2026 — Plano M'Cheyne"
            >
              <ReadingPlanWidget />
            </DashboardCard>
            ...
            <DashboardCard
              ...
              subtitle="412 Recursos Sincronizados"
