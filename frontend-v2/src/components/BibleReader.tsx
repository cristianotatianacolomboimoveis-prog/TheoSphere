          ...
          {showTranslationSelector && (
            <div className="absolute inset-0 z-[100] bg-white/95 dark:bg-black/95 backdrop-blur-xl p-10 overflow-y-auto">
              <div className="max-w-xl mx-auto space-y-4">
                <h2 className="text-xl font-serif font-bold mb-8 text-center">
                ...
                {TRANSLATIONS.map((t) => (
                  <button
                    ...
                    className={`w-full p-6 rounded-xl border transition-all text-left ${primaryTranslation === t.id ? "bg-blue-600 border-blue-600 text-white shadow-xl" : "bg-gray-50 border-gray-200 hover:border-blue-500"}`}
                  >
