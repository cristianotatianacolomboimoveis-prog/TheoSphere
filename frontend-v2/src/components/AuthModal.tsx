        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-foreground/60 mt-2">
              {isLogin
                ? "Acesse o TheoSphere PhD com suas credenciais."
                : "Junte-se à elite da pesquisa teológica."}
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-foreground/50 uppercase tracking-wider mb-1.5 ml-1">
                E-mail
              </label>
              <input
                type="email"
