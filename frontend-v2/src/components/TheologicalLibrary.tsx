...
const PUBLIC_BOOKS: BookItem[] = [
  {
    ...
    year: "397 d.C.",
    summary:
      "A clássica jornada espiritual e autobiográfica de conversão de Santo Agostinho. Uma das obras fundamentais da patrística e da história ocidental.",
  ...
  },
  {
    ...
    year: "1678",
    summary:
      "A mais famosa alegoria cristã de todos os tempos. Narra a jornada épica de 'Cristão' desde a Cidade da Destruição até a Cidade Celestial.",
  ...
  },
  {
    ...
    year: "1559",
    summary:
      "A obra-prima sistemática da Reforma Protestante. Um compêndio completo da fé cristã, da soberania divina e dos sacramentos.",
  ...
  },
  {
    ...
    year: "1274",
    summary:
      "O maior clássico da teologia escolástica medieval, sintetizando primorosamente a filosofia aristotélica com a teologia bíblica clássica.",
  ...
  },
  {
    ...
    year: "1885",
    summary:
      "Uma exposição homilética magnífica e detalhada do 'Príncipe dos Pregadores' sobre os ensinamentos práticos e celestiais de Jesus.",
  ...
  },
  {
    ...
    year: "1427",
    summary:
      "O clássico manual devocional focado na humildade interior, oração silenciosa, renúncia e na imitação do caráter do Salvador.",
...
export default function TheologicalLibrary({
  ...
  const handleIndexBook = async (book: BookItem) => {
    if (
      indexingStatus[book.id] === "loading" ||
      indexingStatus[book.id] === "success"
    )
      return;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                Integração Direta com a Inteligência Artificial
              </p>
            </div>
          </div>
          <button
        ...
        <div className="mx-8 mt-4">
          ...
          >
            ...
            <button
              ...
              className="text-xs opacity-60 hover:opacity-100 font-bold uppercase tracking-widest pl-2"
            >
              Fechar
            </button>
          </motion.div>
        ...
        {filteredBooks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-gray-400 text-center">
            ...
            <p className="text-xs opacity-60">
              Tente ajustar a sua busca ou trocar a categoria ativa.
            </p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="mb-4">
                      <span className="text-[9px] font-black text-[#00C2FF] uppercase tracking-wider">
                        {book.year}
                      </span>
                      ...
                      <p className="text-xs font-bold text-[#F82E52] mt-0.5">
                        {book.author}
                      </p>
                    </div>
                    ...
                    <div className="flex gap-2 flex-wrap mb-6">
                      {book.subjects.map((s) => (
                        <span
                          key={s}
                          className="text-[9px] font-bold px-2 py-0.5 bg-gray-100 dark:bg-white/5 rounded text-gray-400 uppercase tracking-tighter"
                        >
                          #{s}
                        </span>
                      ))}
      ...
      <div className="p-4 bg-white dark:bg-[#0C0C0F] border-t border-gray-200 dark:border-white/5 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-center sm:text-left">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wide">
            Direitos Autorais: Domínio Público Oficial
          </span>
        </div>
        <div className="flex items-center gap-2">
          <Globe2 className="w-4 h-4 text-[#00C2FF]" />
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wide">
            Conectado aos Servidores do Project Gutenberg
          </span>
        </div>
      </div>
    </div>
