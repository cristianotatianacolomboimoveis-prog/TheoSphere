...
export default function CommunityPage() {
  useTrackContext({
    ...
    metadata: {
      contentSummary:
        "Fóruns de discussão, grupos de estudo e interações com a comunidade teológica.",
    },
  });
    ...
    <div className="p-8 max-w-6xl mx-auto">
      <header className="mb-12">
        ...
        <p className="text-gray-400">
          Conecte-se com outros estudantes e pesquisadores da TheoSphere.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3 space-y-6">
          ...
          {[
            {
              author: "Pr. Marcos Oliveira",
              title: "Interpretação de Romanos 8:28 no contexto original",
              replies: 15,
              likes: 42,
              time: "2h atrás",
            },
            {
              ...
              title: "Novas descobertas sobre os Manuscritos do Mar Morto",
              replies: 28,
              likes: 89,
              time: "5h atrás",
            },
            {
              author: "João Silva",
              title:
                "Dúvida sobre o uso de Strong's para palavras gregas compostas",
              replies: 7,
              likes: 12,
              time: "1 dia atrás",
            },
          ...
          <section className="p-6 rounded-2xl bg-white/5 border border-white/10">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={group}
                  className="text-sm text-gray-400 hover:text-white cursor-pointer transition-colors flex items-center justify-between"
                >
                  {group}
